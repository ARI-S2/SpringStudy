...
$(function() {
	$('#addBtn').click(function() {
		$('#user-table > table').append(
			'<tr id="m'+(fileIndex)+'">'
			+'<td width=20%>파일 '+(fileIndex+1)+'</td>'
			+'<td width=80%><input type=file name=file['+(fileIndex)']></td>'
			+'</tr>'
		)
   ...
   <div class="row">
     ...
     <table class="table">
       ...
       <tr>
       	...
       	<td>
       		<input type=button value="추가" class="btm-xs btn-success" id="addBtn">
       		<input type=button value="취소" class="btm-xs btn-info" id="removeBtn">
       	</td>
       </tr>
       <tr>
